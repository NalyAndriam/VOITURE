...
public class ReservationDaoImpl implements ReservationDao {
    ...
    public List<Reservation> getAll() {
        ...
        try {
            ...
            String sql = """
                    Select r.id, r.nom, r.prenom,prenom, r.heure_arrivee, r.nb_personne,
                           r.id_hotel, h.nom AS nom_hotel,
                           COALESCE(d.km, 0) AS distance_km from Reservation r
    ...
    public List<Reservation> getReservationsByDate(Date date) {
        ...
        try {
            ...
            String sql = """
                    SELECT r.id, r.nom, r.prenom,prenom, r.heure_arrivee, r.nb_personne,
                           r.id_hotel, h.nom AS nom_hotel,
                           COALESCE(d.km, 0) AS distance_km
                    FROM Reservation r
                    JOIN Hotel h ON r.id_hotel = h.id
                    LEFT JOIN Distance d ON d.vers = r.id_hotel AND d.depart = 'TNR'
            ...
            // TA MÉTHODE CLOSE EST UTILISÉE ICI → PLUS DE StackOverflow
            DatabaseConnection.close(rs, ps, conn);
        }
        return list;
    }
